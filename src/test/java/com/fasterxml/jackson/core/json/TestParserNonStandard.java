    ...
    extends com.fasterxml.jackson.test.BaseTest
{
    ...
    public void testAllowInfinity() throws Exception {
        _testAllowInf(false);
        // Skip testing the stream parser to avoid the potential for
        // unnecessary confusion between the parsers during an interview.
        // _testAllowInf(true);
    }
...
//        }
        ...
        JsonToken tkn = jp.nextToken();
        assertToken(JsonToken.VALUE_NUMBER_FLOAT, tkn);
        double d = jp.getDoubleValue();
